...
@section('container')
    <div class="page-heading d-flex justify-content-between">
        ...
        <div class="flex-end">
            <select name="#" id="tahunSelect" class="form-control btn btn-primary" onchange="handleChange(this)">
                <option selected hidden>Pilih Tahun</option>
                <option value="{{ route('omzet.index') }}">Semua Data</option>
                @foreach ($year_select as $item)
                    <option {{ !empty($year) && $year == $item->year ? 'selected' : '' }}
                        value="{{ route('omzet.filter', $item->year) }}">{{ $item->year }}</option>
                @endforeach
            </select>
        </div>
    </div>
                                    ...
                                    <tbody>
                                        @foreach ($data as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <button class="btn btn-light-secondary btn-sm" data-bs-toggle="modal"
